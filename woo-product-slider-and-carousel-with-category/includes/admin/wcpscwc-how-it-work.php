				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo esc_url( WCPSCWC_PLUGIN_LINK_UPGRADE ); ?>" target="_blank"><?php esc_html_e('Upgrade To PRO', 'woo-product-slider-and-carousel-with-category'); ?></a>
						</div>
					</div>
				</div>
			</div>
